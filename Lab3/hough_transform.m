...
img_h = rgb2gray(imread('highway1.jpg'));
[rr,cc]=size(img_h);
BW = edge(img_h,'sobel');
figure, sgtitle('Hough Transform highway1.jpg')
subplot(3,2,1),imagesc(img_h),colormap (gca,'gray'), title('Original image highway1.jpg')
...
P  = houghpeaks(H,4);%4 is the number of peaks to identify
